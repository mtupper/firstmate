...
family_for_basename() {
  case "$1" in
    ...
    fm-afk-inject-e2e.test.sh|fm-afk-return.test.sh)
      printf '%s\n' afk
      ;;
    fm-bearings-snapshot.test.sh|fm-fleet-snapshot-view.test.sh|fm-fleet-feed.test.sh)
      printf '%s\n' snapshot-bearings
      ;;
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-inject-e2e.test.sh 36069
tests/fm-afk-pi-herdr-return-e2e.test.sh 67
tests/fm-afk-return.test.sh 1809
tests/fm-ask-user-authority.test.sh 90
tests/fm-backend-cmux-smoke.test.sh 33
tests/fm-backend-cmux.test.sh 14717
tests/fm-backend-herdr-focus-flash-e2e.test.sh 23
tests/fm-backend-orca.test.sh 12839
tests/fm-backend-tmux-smoke.test.sh 428
tests/fm-backend-zellij-smoke.test.sh 22
tests/fm-backend-zellij.test.sh 9268
tests/fm-backend.test.sh 38184
tests/fm-backlog-handoff.test.sh 3469
tests/fm-bearings-snapshot.test.sh 77805
tests/fm-bootstrap.test.sh 38422
tests/fm-busy-adapter-wiring.test.sh 15312
tests/fm-busy-state.test.sh 760
tests/fm-calm-pi-extension.test.sh 1117
tests/fm-classify-decision-key.test.sh 643
...
tests/fm-control-relaunch.test.sh 27390
tests/fm-control.test.sh 37433
tests/fm-cursor-harness.test.sh 30079
tests/fm-cursor-primary-live-e2e.test.sh 22
tests/fm-cursor-primary.test.sh 42828
tests/fm-daemon.test.sh 18117
tests/fm-documentation-audiences.test.sh 3131
tests/fm-fleet-feed.test.sh 5074
tests/fm-fleet-snapshot-view.test.sh 8546
tests/fm-fleet-sync.test.sh 27791
tests/fm-gate-refuse.test.sh 4189
tests/fm-gitignore-config.test.sh 22
tests/fm-gotmp.test.sh 514
tests/fm-grok-continuity-live-e2e.test.sh 15
tests/fm-grok-stop-live-e2e.test.sh 20
tests/fm-guard-stale-banner.test.sh 11834
tests/fm-harness-liveness-drift-live-e2e.test.sh 20
tests/fm-herdr-session-cleanup.test.sh 6888
tests/fm-herdr-version-floor-live-e2e.test.sh 24
tests/fm-inactive-reconcile.test.sh 39753
tests/fm-kimi-harness.test.sh 14050
tests/fm-muse-harness.test.sh 28014
tests/fm-muse-signals-live-e2e.test.sh 24
tests/fm-on.test.sh 9359
tests/fm-opencode-primary-live-e2e.test.sh 17
tests/fm-operational-input.test.sh 226
tests/fm-path-spelling.test.sh 5928
tests/fm-pending-reply.test.sh 76494
tests/fm-pi-primary-live-e2e.test.sh 15
tests/fm-pi-watch-extension.test.sh 16348
tests/fm-pr-check-security.test.sh 182579
tests/fm-procevent-when.test.sh 16111
tests/fm-procevent.test.sh 58334
tests/fm-project-origin.test.sh 115
tests/fm-project-write-pretool-check.test.sh 794
tests/fm-public-followup.test.sh 41735
tests/fm-quota-array-dispatch-live-e2e.test.sh 22
tests/fm-remote-backlog-handoff.test.sh 18887
tests/fm-remote-doctor.test.sh 4966
tests/fm-remote-entrypoint.test.sh 111
tests/fm-remote-job-orphan-reap.test.sh 3005
tests/fm-remote-job.test.sh 49460
tests/fm-remote-reply.test.sh 33387
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 201360
tests/fm-remote-secondmate-parent-binding.test.sh 15281
tests/fm-remote-secondmate-trace-context.test.sh 32668
tests/fm-secondmate-harness.test.sh 131660
tests/fm-secondmate-lifecycle-e2e.test.sh 17195
tests/fm-secondmate-liveness.test.sh 29813
tests/fm-secondmate-safety.test.sh 49496
tests/fm-secondmate-sync.test.sh 17813
tests/fm-send-resolve-key.test.sh 13654
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 56
tests/fm-send-secondmate-marker.test.sh 4828
tests/fm-session-lock-ancestry.test.sh 1301
tests/fm-session-start.test.sh 142861
tests/fm-sessionstart-hook-live-e2e.test.sh 21
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 21
tests/fm-sessionstart-nudge.test.sh 30540
tests/fm-shared-captain-inheritance.test.sh 5645
tests/fm-spawn-dispatch-profile.test.sh 59435
tests/fm-spawn-pool-base-freshen.test.sh 13371
tests/fm-spawn-worktree-settle.test.sh 4773
tests/fm-startup-memory-budget.test.sh 6700
tests/fm-startup-network.test.sh 53447
tests/fm-stow-cascade.test.sh 3129
tests/fm-subagent-pretool-check.test.sh 752
tests/fm-supervision-events.test.sh 460
tests/fm-tangle-guard.test.sh 8537
tests/fm-task-delivery.test.sh 2354
tests/fm-teardown-endpoint-safety.test.sh 12877
tests/fm-teardown.test.sh 66009
tests/fm-test-fixture-cleanup.test.sh 539
tests/fm-test-isolation-proof.test.sh 1944
tests/fm-tmux-agent-liveness.test.sh 6071
tests/fm-trace-context-lib.test.sh 227
tests/fm-trace-context-spawn.test.sh 35480
tests/fm-turnend-guard.test.sh 18833
tests/fm-update.test.sh 5348
tests/fm-vendor-auth-probe.test.sh 43447
tests/fm-wake-daemon-lifecycle-e2e.test.sh 16474
tests/fm-wake-drain-open-decisions-cursor.test.sh 12457
tests/fm-wake-drain-open-decisions.test.sh 21799
tests/fm-wake-drain-unread-status.test.sh 44116
tests/fm-wake-queue.test.sh 44197
tests/fm-watch-arm.test.sh 58568
tests/fm-watch-checkpoint.test.sh 4730
tests/fm-watch-triage.test.sh 159252
tests/fm-watcher-lock.test.sh 56390
EOF
}
